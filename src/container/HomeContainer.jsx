...
import { fetchAllMoviesRequest } from "../store/movies/movieActions";
...
const HomeContainer = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllMoviesRequest(pageNo));
  }, [dispatch, pageNo]);
  ...
  return (
    ...
    //   <h2 className="text-5xl pt-5 pb-10 text-white">Popular Movies</h2>
