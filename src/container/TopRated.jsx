...
import { fetchTopRatedMoviesRequest } from "../store/movies/movieActions";
...
const TopRated = () => {
  ...
  useEffect(() => {
    dispatch(fetchTopRatedMoviesRequest(pageNo));
  }, [dispatch, pageNo]);

  // if (loading) return <div className="loader"></div>;
  return (
    <div className="bg-gray-800 px-3 sm:px-[5vw] lg:px-[9vw] pt-24">
      <h2 className="text-5xl pt-5 pb-10 text-white">Top Rated Movies</h2>
